...
export default function AddExam() {
  const [topicName, setTopicName] = useState<string>("HTML Tag Explorer");
  const [subjectDescriptions, setSubjectDescriptions] = useState<string>("Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro rerum assumenda possimus nisi sit adipisci vitae eos quo, distinctio quos.");
