  ...
  return (
    <div className="p-3 sm:p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center mb-6">
        <Link href="/teacher/subjectDetails">
            ...
            <Card key={index} className="p-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <img
                    src={`/teacher/student${index + 1}.jpg`}
                    alt="Student"
                    className="w-12 h-12 rounded-full object-cover"
                  />
                  <div>
                    <h3 className="font-semibold text-gray-900">Shen Woaini</h3>
                    <p className="text-sm text-gray-600 flex items-center gap-1">
                ...
                {/* Right: Verified + Button */}
                <div className="flex items-center gap-3">
                  <span className="text-blue-600 text-sm font-semibold flex items-center gap-1">
                    <BadgeCheck size={16} />
                    VERIFIED
                  </span>
                  <Button className="bg-black hover:bg-gray-800 flex items-center gap-1">
                    <Eye size={14} />
                    Details
                  </Button>
                </div>
