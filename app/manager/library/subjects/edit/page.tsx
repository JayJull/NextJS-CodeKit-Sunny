...
export default function EditSubject() {
  ...
  const [topicName, setTopicName] = useState<string>("Object Sketching");
  const [subjectDescriptions, setSubjectDescriptions] = useState<string>(
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti repellendus consectetur impedit? Laboriosam, voluptatum ratione?"
  );
  const [selectedTopic, setSelectedTopic] = useState<string>("Science");
  const [selectedTeacher, setSelectedTeacher] =
    useState<string>("Armin Yeager");
